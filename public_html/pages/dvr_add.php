<!-- Dvr Modal -->
<div class="modal fade" id="dvr" tabindex="-1" aria-labelledby="dvr_model" aria-hidden="true">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
    <div class="modal-header">
        <h1 class="modal-title fs-5">Add Dvr</h1>
    ...
    <form>
        ...
        <div class="mb-3 row">
            <div class="col-md-6">
                ...
                <select name="dvr_d_cat" class="form-control" id="dvr_d_cat">
                    <option value="">Select depot</option>
                </select>
            </div>
            <div class="col-md-6">
                <label for="child depot">category</label>
                <select name="dvr_c_depot" class="form-control" id="dvr_c_depot">
                    <option value=""></option>
                </select>
            </div>
        </div>
