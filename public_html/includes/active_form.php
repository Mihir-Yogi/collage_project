...
if(isset($_POST["active_n_d"]) && isset($_POST["active_n_c"]) && isset($_POST["new_nvr_section"]) && isset($_POST["new_nvr_make"]) && isset($_POST["new_nvr_serial_no"]) && isset($_POST["new_nvr_purchase_date"]) && isset($_POST["new_nvr_warranty"]) && isset($_POST["new_nvr_ex_date"])) {

    $dbOperation = new DBoperation();

    $depot = $_POST["active_n_d"];
    $category = $_POST["active_n_c"];
    $section = $_POST["new_nvr_section"];
    $device_category = "nvr";
...
if(isset($_POST["active_d_d"]) && isset($_POST["active_d_c"]) && isset($_POST["new_dvr_section"]) && isset($_POST["new_dvr_make"]) && isset($_POST["new_dvr_serial_no"]) && isset($_POST["new_dvr_purchase_date"]) && isset($_POST["new_dvr_warranty"]) && isset($_POST["new_dvr_ex_date"])) {

    $dbOperation = new DBoperation();

    $depot = $_POST["active_d_d"];
    $category = $_POST["active_d_c"];
    $section = $_POST["new_dvr_section"];
    $device_category = "dvr";
...
if(isset($_POST["active_h_d"]) && isset($_POST["active_h_c"]) && isset($_POST["new_hdd_section"]) && isset($_POST["new_hdd_make"]) && isset($_POST["new_hdd_serial_no"]) && isset($_POST["new_hdd_purchase_date"]) && isset($_POST["new_hdd_warranty"]) && isset($_POST["new_hdd_ex_date"])) {

    $dbOperation = new DBoperation();

    $depot = $_POST["active_h_d"];
    $category = $_POST["active_h_c"];
    $section = $_POST["new_hdd_section"];
    $device_category = "hdd";
